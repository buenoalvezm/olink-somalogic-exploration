...
write_tsv(de_diseases, "data/processed/de_diseases_olink_soma_v3.tsv") # long format, combined
...
write_tsv(de_diseases_overlapping, "data/processed/de_diseases_olink_soma_overlapping_v3.tsv") # wide format, overlapping
