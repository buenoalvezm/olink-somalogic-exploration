...
rescued_proteins_plot <- ggplot(rescue_results_disease, aes(x = reorder(Disease, -n_rescued), y = n_rescued)) +
  ...
  labs(
    title = "'Rescued' Proteins per Disease",
    x = "Disease"
  ) +
  theme_hd() +
  theme(
...
Calculate maximum correlation per protein across Diseases and plot distribution. Max correlation (top-left)
